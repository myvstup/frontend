describe('controllers', () => {
  ...
  beforeEach(angular.mock.module('myVstup'));
  ...
  it('Connection basic test', () => {
    expect(true).toEqual(true);
  });

  xit('should have a timestamp creation date', () => {
    expect(vm.creationDate).toEqual(jasmine.any(Number));
  });

  xit('should define animate class after delaying timeout', inject($timeout => {
    $timeout.flush();
